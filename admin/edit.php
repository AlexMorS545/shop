...
<div class="admin-form-wrp">
  <form action="" method="post" enctype="multipart/form-data" class="admin-form">
    <img src="../src/public/<?=$product['image']?>" alt="<?= $product['name']?>" name="image">
    <div class="desc-wrp">
...
<!--      <lable>Изменить картинку:<br><input type="file" name="img" accept="image/jpeg, image/png, image/gif"></lable>-->
